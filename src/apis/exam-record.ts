...
export function ApiGetClassesExamRecord(roomId: number, classesId: number): ApiResult<ExamRecord[]> {
    return http.request({
...
export function ApiGetExamStatistic(roomId: number): ApiResult<any> {
    return http.request({
