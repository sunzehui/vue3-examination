<template>
  <n-card>
    ...
    <el-dialog v-model="dialogFormVisible" title="学生成绩">
      <ExamRecordCompnent :record_id="recordId"/>
      <template #footer>
...
import {ApiGetClassesExamRecord, ApiGetExamRecord, ApiGetExamStatistic} from '@/apis/exam-record'
...
async function init() {
  ...
  const examRecordListResult = await ApiGetClassesExamRecord(room_id, classes_id)
